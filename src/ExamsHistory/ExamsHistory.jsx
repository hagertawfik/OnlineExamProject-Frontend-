...
export default function ExamsHistory(props) {
    ...
    const GetExamsResult = async () => {
        try {
          const {data} = await AuthAxios.get(`/ExamHistory/AllExamsHistory?page=${currentPage}&pageSize=${pageSize}`);
          setExamsResult(data)
        } catch (error) {
...
<div className="bg-white overflow-auto w-75 m-auto shadow-lg  rounded-lg">
    <h1 className="text-center text-spec py-5 bg-light border-bottom"> ExamsResult</h1>
    <div className="p-4">
    <div className="exams">
        ...
        <table className="table ">
          <thead>
            <tr >  
              ...
              <th className="col">Subject ID</th>
